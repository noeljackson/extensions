...
class MaterialTests(unittest.TestCase):
    ...
    def test_canonical_lock_binds_accepted_sources(self) -> None:
        expected = {
            "extensions": (
                "2a533ae7eb4d3674829907144200a49c1f2e03ee",
                "b5fbbb360aa0e7581104ca270d85c17c607e3863",
            ),
            "guest_components": (
                "89c85437529a13c1de9e81d471444bc4ff8626b8",
                "6c45ca00a68de99b14b2249ef8cd85ed6482b832",
            ),
            "kata_containers": (
...
''',
            ...
            "rootfs/usr/local/share/kata-containers/vmlinuz-6.18.48-202": b"kernel",
            "rootfs/usr/local/share/kata-containers/vmlinuz.container": "vmlinuz-6.18.48-202",
